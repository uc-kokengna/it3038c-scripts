...
#GENERATES HTML REPORT ONTO DESKTOP. OPEN NEWLY CREATED HTML REPORT (AUTO OPENS IN BROWSER)

#CHANGE -FILEPATH TO HAVE REPORT GENERATE IN ANOTHER AREA. 

#REFRESH FILE REPORT (IN BROWSER) AFTER MAKING CHANGES TO UPDATE REPORT INFO.

#CHANGE THE NAME OF THE REPORT AFTER FINISHING
